...
export default ({nik, name, place_of_birth, date_of_birth, gender, address, citizen, religion, profession, count}) => {
    moment.locale("id");
        ...
        <body>
            ...
            <section>
                <div style="text-align: center; margin-bottom: 2rem">
                    ...
                    <p>Nomor : 0${count}/09/PD-KDL/${month}/${year}</p>
                </div>
                ...
                <div style="margin-bottom: 2rem">
                    <p style="margin: 1rem 0">Dengan ini menerangkan bahwa orang yang bersangkutan, beralamat dan Berdomisili  di ${address}.</p>
