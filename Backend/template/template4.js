...
export default ({nik, name, place_of_birth, date_of_birth, gender, address, citizen, religion, profession, note}) => {
    moment.locale("id");
    ...
    return `
        ...
        <section>
            ...
            <div style="margin-bottom: 2rem">
                <p style="margin: 1rem 0">Dengan ini menerangkan bahwa orang tersebut adalah warga kami dan benar mempunyai usaha : ${note}</p>
